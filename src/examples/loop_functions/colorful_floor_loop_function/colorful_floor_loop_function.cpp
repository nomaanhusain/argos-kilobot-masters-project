...
void CColorfulFloorLoopFunction::loop(int x, int y) {
        // the real line is
    // test_counter += 1;
...
void CColorfulFloorLoopFunction::set_IR_message(int x, int y, IR_message_t &m, cell_num_t cn) {
    // get correct cell
...
void CColorfulFloorLoopFunction::CAN_rx(int x, int y, CAN_message_t *m) {
...
void CColorfulFloorLoopFunction::virtual_message_reception() {
...
CVector2 CColorfulFloorLoopFunction::position2cell(CVector2 t_position) {
...
CVector2 CColorfulFloorLoopFunction::position2module(CVector2 t_position) {
...
CVector2 CColorfulFloorLoopFunction::module2cell(CVector2 module_pos, cell_num_t cn) {
...
CVector2 CColorfulFloorLoopFunction::GetKilobotPosition(CKilobotEntity &c_kilobot_entity) {
...
UInt16 CColorfulFloorLoopFunction::GetKilobotId(CKilobotEntity &c_kilobot_entity) {
    std::string strKilobotID((c_kilobot_entity).GetControllableEntity().GetController().GetId());
    return std::stoul(strKilobotID.substr(2));
}

void CColorfulFloorLoopFunction::IR_rx(int x, int y, IR_message_t *m, cell_num_t c, distance_measurement_t *d, uint8_t CRC_error) {
...
void CColorfulFloorLoopFunction::GetDebugInfo() {
...
CColor CColorfulFloorLoopFunction::GetFloorColor(const CVector2 &vec_position_on_plane) {
...
UInt16 CColorfulFloorLoopFunction::position2option(CVector2 t_position) {
...
void CColorfulFloorLoopFunction::read_configuration(std::string conf_file) {
...
void CColorfulFloorLoopFunction::setup(int x, int y) {
    // the real line is
...
void CColorfulFloorLoopFunction::set_LED_with_brightness(int x, int y, cell_num_t cn, color_t color, brightness_t brightness) {
    module_memory[x][y].cell_colour[cn] = color;
    GetSpace().GetFloorEntity().SetChanged();
}

void CColorfulFloorLoopFunction::init_CAN_message(CAN_message_t *cell_msg) {
    uint8_t d;
...
uint8_t CColorfulFloorLoopFunction::CAN_message_tx(CAN_message_t *m, kilogrid_address_t add) {
