...
json_files = [base_path+'ir1.0_w0.6_cn0.2_sn0.35/'+file_name, base_path+'ir0.8_w0.6_cn0.2_sn0.35/'+file_name, 
              base_path+'ir0.6_w0.6_cn0.2_sn0.35/'+file_name]
ir_vals = [1.0,0.8,0.6]
accuracies = []
...
def plot_json_data(json_files):
    ...
    plt.ylabel(r'$\phi_{avg}$',fontsize=20)
    plt.yticks(fontsize=20)
    plt.title(r'$\omega=0.6$ $\eta=0.2$ $\zeta=0.35$',fontsize=20)
    plt.legend()
